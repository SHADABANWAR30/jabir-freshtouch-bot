...
origins = [
    ...
    "http://localhost:3000",       # vite-react-main dev server
    "http://localhost:3100",       # fabrico-app (Capacitor) dev server
    "capacitor://localhost",       # Capacitor app on iOS
    "https://localhost",           # Capacitor app on Android
]
